...
import { TimeCapsuleClient } from "@/components/time-capsule/time-capsule-client"
...
export default async function TimeCapsulePage() {
    ...
    const { data: capsules } = await supabase
        .from("time_capsules")
        .select("*, items:time_capsule_items(*, contributor:profiles!contributor_id(full_name, avatar_url))")
        .eq("family_id", profile.family_id)
